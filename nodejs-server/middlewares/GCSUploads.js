        ...
        upload(req, res, (multerError) => {
            ...
            blobStream.on('finish', async () => {
                ...
                try {
                    ...
                    // Return a JSON response instead of passing to Express error handler
                    return res.status(500).json({
                        success: false,
                        message: "Failed to make file public in Google Cloud Storage",
                        error: publicError.message || "Unknown error occurred"
                    });
                }
            });
